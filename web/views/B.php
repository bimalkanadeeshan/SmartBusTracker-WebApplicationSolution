...
$query="SELECT BusId,ArrivalTime FROM ((routetable INNER JOIN bustable  ON RouteId=RouteIdFK) INNER JOIN arrivaltable ON BusID=BusIdFK ) where  RouteDirection=2 && City= '".$From."'";

$result_set=mysqli_query($connection,$query);
}

else{
  $query="SELECT BusRoute,BusId,ArrivalTime FROM ((routetable INNER JOIN bustable  ON RouteId=RouteIdFK) INNER JOIN arrivaltable ON BusID=BusIdFK ) where  RouteDirection=1 && City= '".$From."'";
